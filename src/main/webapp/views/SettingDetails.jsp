                                ...
                                <div class="p-5">
                                    ...
                                    <form action="SettingDetail">
                                        ...
                                        <input class="form-control" type="hidden" name="setting_id"
                                               value="${s.setting_id}"/>
                                        Setting Type:
                                        <input class="form-control" type="text" name="settingType" value="${s.type_id}"
                                               hidden=""/>${typeValue.get(s.type_id - 1)}
                                        <br> Order(*):
                                        <input class="form-control" type="text" name="order" value="${s.display_order}"
                                               required/>
                                        Setting Title(*):
                                        <input class="form-control" type="text" name="lessontype"
                                               value="${s.setting_title}" required/>
                                        Value:
                                        <input class="form-control" type="text" name="value" value="${s.setting_value}"
                                               style=""/>
                                        Status:
                                        <br> <input type="radio" name="status" value="1" ${s.status == 1?"checked":""}/>Active
                                        <input type="radio" name="status" value="2" ${s.status == 2?"checked":""}
                                               style="margin-left: 100px"/>Deactive
                                        <br>Description:
