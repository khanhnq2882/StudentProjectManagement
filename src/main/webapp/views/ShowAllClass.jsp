                    ...
                    <div class="card-body">
                        ...
                        <div>
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light ">
                                ...
                                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                    <form class="form-inline my-2 my-lg-0" action="ShowAllClass?go=ViewAllClass"
                                          method="POST">
                                        ...
                                        <input class="form-control mr-sm-2" type="text" name="searchClass"
                        ...
                        <div class="table-responsive">
                                ...
                                <c:forEach var="o" items="${vect}">
                                    <tr>
                                        <form method="POST" action="UpdateLecture" id="Lec${o.id}">
                                            ...
                                            <td>
                                                <select class="form-control form-control-user" name="Lecture"
                                                        onchange="submitForm(Lec${o.id})">
                                        ...
                                        <td>
                                            ...
                                            <a href="ClassUser4Admin?class_id=${o.id}"><span
                            ...
                            <c:forEach var="k" begin="1" end="${soLuongTrang}">
                                <a href="ShowAllClass?go=ViewAllClass&page=${k}&searchClass=${search}"
                                   class="${page == k ? "collapse-item active":""}"> Page ${k}</a>
                            </c:forEach>
                        </div>
                    </div>
                </div>
