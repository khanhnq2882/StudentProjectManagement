            ...
            <div class="container card">
                <div class="card-body">
                    ...
                    <form action="ShowAllClass?go=<%=update.equals("updateClass") ? "updateClass":"AddClass" %>"
                        ...
                        <input class="form-control form-control-user" type="hidden" name="go"
                               value="<%=update.equals("updateClass") ? "updateClass":"AddClass" %>"/>
                        <strong> Class Code </strong>
                        <input class="form-control form-control-user" type="text" name="class_code"
                               value="${class_code}" placeholder="Example: AA1234"/>
                        Trainer

                        <select name="trainer" class="form-control form-control-user">
                            <option value="">--Change here--</option>
                            <c:forEach var="o" items="${vectT}">
                                <option value="${o.user_id}" ${o.user_id == trainer ? "selected" : ""}>${o.roll_number}
                                    - ${o.fullname}</option>
                            </c:forEach>
                        </select>
                        ...
                        <input class="form-control form-control-user" type="number" min="1"
                               max="2022" step="1" name="class_Year"
                               value="${class_Year != null ? class_Year : "2022"}"/>
                        ...
                        <label for="true"><input type="radio" id="true" name="block5"
                                                 value="1" ${block5 == 1 ? "checked":""} ${block5 == null ? "checked" : ""}/>True</label>
                        <label for="false"><input type="radio" id="false" name="block5"
                                                  value="0" ${block5 == 0 ? "checked":""}/>False</label>
                        <br>
                        <strong> status </strong>
                        <label for="act">
                            <input id="act" type="radio" name="status"
                                   value="1" ${status == 1 ? "checked":""} ${status == null ? "checked" : ""}/>Active</label>
                        <label for="dea"><input type="radio" id="dea" name="status"
