  ...
  function (e) {
    ...
    function T(e, t) {
      ...
      if (
        ...
        var s = o.querySelector(e.autoFocusTag);
        s &&
          setTimeout(function () {
            return s.focus();
          }, e.autoFocusDelay);
    ...
    return (
      Object.keys(z).forEach(function (e) {
        return (R[e] = function (t, n, r) {
          var a = r ? _objectSpread(_objectSpread({}, D), r) : D;
          (p = g(a.svgColor, 9)),
            (function (e, t, n, r) {
              var a =
                "object" === _typeof(e)
              ...
              if (a) {
                ...
                var o =
                    n && "object" === _typeof(n)
                      ? _objectSpread(_objectSpread({}, D), n)
                      : D,
                  i = '<div data-id="'
                    .concat(D.cid, '" class="f f__cb" style="background:')
                    .concat(
                      o.background,
      ...
      (R.Remove = function (e, t) {
        var n =
          "object" === _typeof(e)
            ? e.querySelector('div[data-id="'.concat(D.cid, '"]'))
            : "string" == typeof e
            ? document.querySelector(e + ' div[data-id="'.concat(D.cid, '"]'))
            : null;
        if (n) {
      ...
      { Ask: M, Alert: A, Dialogue: B, Hint: N, Wait: E, Box: R }
    );
  }
);
